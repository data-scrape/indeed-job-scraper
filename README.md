...
> Free Indeed job scraper - extract job postings, salaries, company info

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/indeed-job-scraper?style=flat-square)](https://github.com/data-scrape/indeed-job-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/indeed-job-scraper?style=flat-square)](https://github.com/data-scrape/indeed-job-scraper/forks)
...
**Indeed Job Scraper** is a free, open-source Python scraper for **Indeed**. Extract structured data from indeed with full pagination support, proxy rotation, and multiple export formats.

indeed job scraper, indeed scraper, scrape indeed jobs
...
- ✅ Posting date & easy apply flag
- ✅ Company rating & reviews count
- ✅ Pagination support (up to 1000+ jobs)
...
```bash
git clone https://github.com/data-scrape/indeed-job-scraper.git
...
```bash
python scraper.py "Software Engineer in San Francisco, CA"
```
...
`job_id` | `title` | `company` | `company_rating` | `location` | `salary_range` | `job_type` | `posted_date` | `is_easy_apply` | `description` | `url`

## 💡 Use Cases

- Job market analysis & salary trends
