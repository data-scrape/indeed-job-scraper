#!/usr/bin/env python3
"""
Indeed Job Scraper - Free Indeed job scraper - extract job postings, salaries, company info
Open source scraper for indeed job scraper, indeed scraper, scrape indeed jobs
...
class IndeedJobScraperScraper:
    """Scraper for Indeed Job Scraper."""
...
def main():
    parser = argparse.ArgumentParser(description="Indeed Job Scraper - Free Indeed job scraper - extract job postings, salaries, company info")
    ...
    scraper = IndeedJobScraperScraper(proxy=args.proxy)
